...
(function(){var $,Lightbox,LightboxOptions;$=jQuery;LightboxOptions=function(){function LightboxOptions(){this.fileLoadingImage="http://ponyup.theoks.net/loading.gif";this.fileCloseImage="http://ponyup.theoks.net/closelabel.gif";this.resizeDuration=700;this.fadeDuration=500;this.labelImage="Image";this.labelOf="of"}return LightboxOptions}();Lightbox=function(){function Lightbox(options){this.options=options;this.album=[];this.currentImageIndex=void 0;this.init()}Lightbox.prototype.init=function(){this.enable();
